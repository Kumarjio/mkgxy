...
<link rel="stylesheet" href="<?php echo config_item('base_url_no_host'); ?>dhtmlsuite/demos/css/demos.css" media="screen" type="text/css">
<link rel="stylesheet" href="<?php echo config_item('base_url_no_host'); ?>styles/common.css" media="screen" type="text/css">
<style type="text/css">
...
<script type="text/javascript" src="<?php echo config_item('base_url_no_host'); ?>dhtmlsuite/js/ajax.js"></script>
<script type="text/javascript">
var DHTML_SUITE_THEME = 'blue';	// SPecifying gray theme
var DHTML_SUITE_THEME_FOLDER = '<?php echo config_item('base_url_no_host'); ?>dhtmlsuite/themes/';
var DHTML_SUITE_JS_FOLDER = '<?php echo config_item('base_url_no_host'); ?>dhtmlsuite/js/separateFiles/';
</script>	
<script type="text/javascript" src="<?php echo config_item('base_url_no_host'); ?>dhtmlsuite/js/dhtml-suite-for-applications-without-comments.js"></script>
...
<div id="eastContent">
<script language="javascript" type="text/javascript" src="/phpads/js.php"></script>
</div>
<!-- END DATASOURCES -->
<script type="text/javascript">
...
<ul id="menuModel" style="display:none">
	<li id="50000"><a href="<?php echo config_item('base_url_no_host'); ?>" title="Home">Home</a></li>
		...
		<ul width="150">
			...
			<li id="5000112" jsFunction="openPage('center', 'pages_horo', 'pages/horo', 'Kundali Match Details', 'Kundali Match Details')"><a href="#">Kundli Match</a>	
				<ul width="200">
					...
					<?php if (!empty($_COOKIE['MM_UserGroup']) && $_COOKIE['MM_UserGroup'] === 'admin') { ?>
...
<script type="text/javascript">
	...
	DHTMLSuite.configObj.setCssPath('<?php echo config_item('base_url_no_host'); ?>dhtmlsuite/demos/css/');
