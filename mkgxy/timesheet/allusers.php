...
$query_rsUsers = "SELECT * FROM procentris_users ORDER BY username ASC";
...
<table border="1">
  <tr>
    ...
    <td><strong>Add Client </strong></td>
    <td><strong>Leave Balance </strong></td>
    <td><strong>Last Login Dt </strong></td>
  </tr>
  <?php do { ?>
  <tr>
    ...
    <td><a href="timesheet_one.php?user_id=<?php echo $row_rsUsers['user_id']; ?>">Timesheet</a></td>
    <td><a href="../users/editadmin.php?user_id=<?php echo $row_rsUsers['user_id']; ?>">Edit</a></td>
    <td><a href="addclient.php?user_id=<?php echo $row_rsUsers['user_id']; ?>">Add Client</a> </td>
    <td><a href="leavebalance.php?name=<?php echo strtolower($row_rsUsers['name']); ?>">Leave Balance</a> </td>
    <td><?php echo $row_rsUsers['last_login_dt']; ?>&nbsp;</td>
  </tr>
