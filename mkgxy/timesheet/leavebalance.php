...
if (isset($_GET['name'])) {
  $colname_rsLeaveBalance = (get_magic_quotes_gpc()) ? $_GET['name'] : addslashes($_GET['name']);
}
mysql_select_db($database_conn, $conn);
$query_rsLeaveBalance = sprintf("SELECT * FROM procentris_leavebalance WHERE name LIKE '%%%s%%'", $colname_rsLeaveBalance);
