...
define('BASE_HTTP_PATH', 'http://real-money-making.com/md/'); 
define('SERVER_PATH_TO_ADMIN', '/home/consultlawyers/public_html/mkgxy/real-money-making.com/md/admin/');
define('UPLOAD_PATH', '/home/consultlawyers/public_html/mkgxy/real-money-making.com/md/upload_files/');
define('UPLOAD_HTTP_PATH', 'http://real-money-making.com/md/upload_files/');
define('MYSQL_HOST', 'localhost'); # mysql database host
define('MYSQL_USER', 'consultl_user'); #mysql user name
define('MYSQL_PASS', 'passwords123'); # mysql password
define('MYSQL_DB', 'consultl_md'); # mysql database name

define('MDS_RESIZE', 'YES');

# SITE_CONTACT_EMAIL

define('SITE_CONTACT_EMAIL', stripslashes('advt@real-money-making.com'));
