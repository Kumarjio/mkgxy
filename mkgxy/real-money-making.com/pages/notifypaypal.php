...
if (strcmp ($res, "VERIFIED") == 0) {
  ...
  $record_id = $customArr['record_id'];
  $user_id = !empty($customArr['user_id']) ? $customArr['user_id'] : '';

  $insertSQL = sprintf("UPDATE real_money_records_simple set paypal_details = %s, paypal_status = %s, updated_dt = %s WHERE record_id = %s AND user_id = %s",
                       ...
                       GetSQLValueString($record_id, "text"),
