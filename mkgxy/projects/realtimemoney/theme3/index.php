...
<div class="header alt vert">
  <div class="container">
    ...
    <h1>Real Money Making</h1>
      <p class="lead">Sit Back, Relax & Earn Money</p>
      <div>&nbsp;</div>
      <a href="/#step1" class="btn btn-default btn-lg">Get Started</a>
  </div>
</div>

<hr>

<div id="step1" class="blurb">
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        <h1>Step 1: Become a Member</h1>
        <p class="lead">With Yearly Fee of $11.24</p>
      </div>
      <div class="col-md-5">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        <h1>Step 2: View / Click / Quiz about Different Advertisements</h1>
      </div>
    </div>
    <div class="row">
...
<div class="callout" id="sec3">
  <div class="vert">
    <div class="col-md-12 text-center"><h2>Step 3: More you click, more you earn points</h2></div>
