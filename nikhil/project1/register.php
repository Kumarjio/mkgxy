...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO users (username, email, password, name, gender, age, details, created_date) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table>
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="details" cols="50" rows="5"></textarea>
      </td>
    </tr>
    <tr valign="baseline">
