		...
		<nav id="topnav" class="navbar navbar-fixed-top navbar-inverse" role="navigation">
			<div class="container">
				<div class="navbar-header">
					 <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse"> <span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button> <a class="navbar-brand" href="#">BootLander BS 3.0.</a>
				</div>
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					...
					<div class="nav navbar-nav navbar-right">
						 <a class="btn btn-danger navbar-btn">Sign up</a> <a class="btn btn-success navbar-btn">Sign in</a>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="text-left col-xs-12 col-sm-12 col-md-6 col-lg-6 text-right">
						<h1>
							DSGN!
						</h1> <span class="second-sm">Bootstrap 3.0.*</span>
					</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 custom-left">
						...
						<ul class="list-unstyled">
							<li>
								<i class="icon-ok-sign"></i> Feature title goes here
							</li>
							<li>
								<i class="icon-ok-sign"></i> Feature title goes here
							</li>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								 <a href="#" class="btn btn-default btn-lg btn-custom"><i class="icon-play-sign"></i> Watch the demo video</a>
							</div>
						</div>
		...
		<div class="container">
				...
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					<div class="panel panel-default custom-panel">
						...
						<div class="panel-body">
							...
							<p>
								<a class="btn btn-lg btn-block btn-success">BUY PRODUCT</a>
							</p>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-4 col-md-4  col-lg-6">
					<div class="input-group">
						<input type="email" class="form-control input-lg" /> <span class="input-group-btn"><button class="btn btn-primary btn-lg" type="button">SUBSCRIBE!</button></span>
					</div>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-4 col-md-4 col-lg-4 col-xs-12">
					<img class="img-responsive img-rounded" src="http://placehold.it/360x200" alt="" />
